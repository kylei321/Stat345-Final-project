...
```{r, warning= FALSE}
# Print selected reviews good/bad/funny examples - Markov 1
good <- c(44,55,56,61,18)
bad <- c(10,14,25,30,40,97)
funny <- c(11,20,27,69,82,91)
print(generated_reviews$Reviews[good])
print(generated_reviews$Reviews[bad])
print(generated_reviews$Reviews[funny])
```